...
#include "../../Proyecto-Est-DatosI/grupos.h"
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_Grupos_t, stringdata) + ofs \
...
QT_MOC_LITERAL(2, 31, 0)
    ...
    "Grupos\0on_btnVerGrupoA_clicked\0"
};
...
void Grupos::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        switch (_id) {
        case 0: _t->on_btnVerGrupoA_clicked(); break;
        default: ;
        }
    }
    Q_UNUSED(_a);
...
const QMetaObject Grupos::staticMetaObject = {
    { &QMainWindow::staticMetaObject, qt_meta_stringdata_Grupos.data,
      qt_meta_data_Grupos,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_Grupos.stringdata))
